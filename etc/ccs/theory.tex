...
attacks against web applications that use TLS such as CRIME \cite{c1}, TIME\cite{c2} and BREACH\cite{c3}.
...
The compression side-channel attack was first studied by Kelsey \cite{c13} in 2002. 
Kelley and Tamassia\cite{c7}  discuss the notion of \textit{entropy-restricted} semantic
...
tool which we call Rupture \cite{c12}. This generic framework provides an
