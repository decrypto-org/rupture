...
where $Rep$ is the string replacement function defined in 5.1, $\{\beta_1,
\beta_2, \beta_3\}$ are symbols that do not appear in $m$ before masking and :
denotes the concatenation between two strings.
