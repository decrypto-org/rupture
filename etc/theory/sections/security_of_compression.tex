...
compression function $\kappa$ over the secret distribution $\mathcal{M}$ with
...
$\overbar{r} = (r_1, r_2)$ exists, such that $dtc_\alpha(Q, \overbar{r}, \kappa,
...
functionality $\mathcal{O}_R(\kappa, Q, \mathcal{M})$ which produces an
$\overbar{r}$ such that $dtc_\alpha(Q, \overbar{r}, \kappa, \mathcal{M})$ holds.
