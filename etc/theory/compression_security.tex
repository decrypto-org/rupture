...
Let $\mathcal{K}$ be a function from some input distribution $\bar{M}$ to the
...
what consists an origin, what properties same-origin secrets share, and what
cross-compression is. This section describes the key components of the defense
