...
origins, the total size of plaintext response in bytes, and the amount of
...
static data. The secrets are distributed in origins that range from 1 to 49, so
...
response when 49 origins are used. In comparison, disabling compression would
