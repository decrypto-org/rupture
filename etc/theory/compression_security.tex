...
model. Such examples are BREACH \cite{c2}, TIME \cite{c3}, and CRIME \cite{c4}, which are expressed as
...
Network".}. First, we calculated the occurences of each character (letters,
digits and special characters) in the text. Second, we generated the Huffman
...
\bibitem{c1} T. Dierks, E. Rescorla, The Transport Layer Security (TLS)
Protocol Version 1.2, August 2008.

\bibitem{c2} Y. Gluck, N. Harris and A. Prado, "BREACH: Reviving the CRIME attack",
Black Hat USA, 2013.

\bibitem{c3} Be'ery, T. and A. Shulman, "A Perfect CRIME? Only TIME Will Tell",
Black Hat Europe 2013, 2013.

\bibitem{c4} J. Rizzo and T. Duong, "The CRIME attack", Ekoparty, 2012.

\bibitem{c5} De Ryck, Philippe, et al. "Automatic and precise client-side
protection against CSRF attacks." European Symposium on Research in Computer
Security. Springer Berlin Heidelberg, 2011.

\bibitem{c6} M. S. Mayzner, M. E. Tresselt, Tables of Single-letter and Digram
Frequency Counts for Various Word-length and Letter-position Combinations, 1965

\bibitem{c7} [online] URL:
\url{https://w3techs.com/technologies/details/ce-gzipcompression/all/all} [cited
November 2016]

\bibitem{c8} P. Deutsch, "DEFLATE Compressed Data Format Specification version
1.3", RFC 1951, 1996.

\bibitem{c9} NIST, "Announcing the ADVANCED ENCRYPTION STANDARD (AES)", 2001.

\bibitem{c10} B. Moller, T. Duong, K. Kotowicz, This POODLE Bites: Exploiting the SSL 3.0 Fallback, September 2014.

\bibitem{c11} R. Fisher, F. Yates: Statistical tables for biological,
agricultural and medical research, 1938

\bibitem{c12} John Kelsey, "Compression and information leakage of plaintext", 2002.

\bibitem{c13} J. Kelley and R. Tamassia, "Secure Compression: Theory \& Practice",
2014.

\bibitem{c14} J. Alawatugoda, D. Stebila and C. Boyd, "Protecting encrypted
cookies from compression side-channel attacks", 2014.

\bibitem{c15} M. West, "First-Party-Only Cookies", RFC Internet-Draft, 2015.
