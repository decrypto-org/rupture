...
compressed and encrypted with functions $f$, $\textrm{Com}$, and $Enc$. We prove that it
...
\begin{equation*}
    \mathcal{E} = Enc \circ \textrm{Com}
\end{equation*}

$\textrm{Com}$ denotes a compression function as defined above, while $Enc$ denotes an
...
Let $\textrm{Com}$ be a compression function, $Enc$ be a strictly length-monotonic
...
\begin{align*}
    ...
    \text{Adv}_{\mathcal{SE}(Enc, \textrm{Com}), \mathcal{A}, \mathcal{S}}
...
\begin{align*}
    ...
    \text{Adv}_{\mathcal{SE}(Enc, \textrm{Com}), \mathcal{A}, \mathcal{S}_{Amp}}
...
payload. The compression function $\textrm{Com}$ and encryption function $Enc$ are again
...
compression function $\textrm{Com}$, length-leaking $Enc$, and secret distribution
$\mathcal{M}$.
